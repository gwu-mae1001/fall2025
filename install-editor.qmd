...
<!-- - The workshop is desinged with active learning modules with limited number of hardware components.  -->
 ...
 <!-- - Once you finish the **Steps 1, 2 and 3 in the installation instructions** in [prerequisites](install-editor.qmd), fill out the [Pre-workshop survey form](https://tinyurl.com/yrkacfd9).  -->
  - **You will be automatically entered into a raffle in the workshop on 10/17/2025 if you complete the installation check-in form.**
:::
...
- **Step 3:** Download and install **[Anaconda for macOS](anaconda-mac.qmd)**  

- **Step 4:** Download and install **[VS Code for macOS](vscode-mac.qmd)**  
...
- **Step 6:** Create a GitHub account 
  ...
  - Otherwise, follow instructions **[here](github-acct.qmd)**
...
- **Step 9:** Connect to a GWU Computing lab computer 
  - Follow installation instructions **[here](remote-access-mac.qmd)**    
...
- **Step 3:** Download and install **[Anaconda for Windows](anaconda-windows.qmd)**  

- **Step 4:** Download and install **[VS Code for Windows](vscode-windows.qmd)**
...
- **Step 9:** Connect to a GWU Computing lab computer 
  - Follow installation instructions **[here](remote-access-windows.qmd)**  

- **Step 10:** Install SolidWorks for Windows (Optional)
  - Follow installation instructions **[here](solidworks-windows.qmd)**   
