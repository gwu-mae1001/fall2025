...
- **In-class hands-on work, &mu;-labs and other classwork** 50%
- **Quizzes, Reports and Presentations** 20%
<!-- - **Attendance** 5% (will be given awarded to the students who attended all sesssions in MAE1001) -->

**Note:** The above grading breakdown is subject to change during the course for the benefit of the students.

## Grading Scale (subject to change during Fall 2025)
...
- The instructor may seek inputs from the class and decide if course projects will be done individually, in groups or in a combination. 
