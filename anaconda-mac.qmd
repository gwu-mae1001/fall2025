...
Visit the Anaconda download page at [https://www.anaconda.com/download/success](https://www.anaconda.com/download/success).
...
- Double-click the Anaconda disk image (`.dmg` or `.pkg`) file to open it and click on "Allow" when prompted.
...
You should see a terminal open and the Jupyter Notebook server launched in a browser window.
